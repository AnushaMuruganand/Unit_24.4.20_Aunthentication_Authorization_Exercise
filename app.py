...
# Custom 404 PAGE TO RENDER WHEN 404 STATUS CODE 
...
def add_feedback(username):
    ...
    if form.validate_on_submit():
        ...
        flash("Added Feedback successfully!!", "success")
...
def update_feedback(feedback_id):
    ...
    if form.validate_on_submit():
        ...
        flash("Edited the Feedback successfully!!", "success")
